...
class User extends BaseUser
{
	...
	public function submitNote($notebook, $input_note)
	{
		...
		{
			var_dump("The template note for the input note was not found", $structure['templates'], $input_note, $template_note);
			die();
		...
		Yii::log('Sent CreateHIT request: '.print_r($Request, true), 'flow', __METHOD__);
